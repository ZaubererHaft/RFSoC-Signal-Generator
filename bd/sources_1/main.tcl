...
\
  ...
  if { [catch {set modulator_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
    ...
    set_property CONFIG.ref_clk_mhz {64} $modulator_0
  ...
  # Create instance: mod_type, and set properties
  set mod_type [ create_bd_cell -type inline_hdl -vlnv xilinx.com:inline_hdl:ilconstant mod_type ]
  set_property CONFIG.CONST_WIDTH {4} $mod_type


  # Create instance: data_in, and set properties
  set data_in [ create_bd_cell -type inline_hdl -vlnv xilinx.com:inline_hdl:ilconstant data_in ]
  set_property -dict [list \
    CONFIG.CONST_VAL {0xC0FE} \
  ...
  [get_bd_pins usp_rf_data_converter_0/s13_axis_tdata]
  connect_bd_net -net ilconstant_0_dout  [get_bd_pins mod_type/dout] \
  [get_bd_pins modulator_0/mod_type]
  connect_bd_net -net ilconstant_0_dout1  [get_bd_pins data_in/dout] \
  [get_bd_pins modulator_0/data_in]
  connect_bd_net -net modulator_0_data_out_i  [get_bd_pins modulator_0/data_out_i] \
  [get_bd_pins ilconcat_0/In0]
  connect_bd_net -net modulator_0_data_out_q  [get_bd_pins modulator_0/data_out_q] \
  [get_bd_pins ilconcat_0/In1]
  connect_bd_net -net modulator_0_valid  [get_bd_pins modulator_0/valid] \
  [get_bd_pins usp_rf_data_converter_0/s13_axis_tvalid]
  ...
  [get_bd_pins modulator_0/clk]
  connect_bd_net -net usp_rf_data_converter_0_s13_axis_tready  [get_bd_pins usp_rf_data_converter_0/s13_axis_tready] \
  [get_bd_pins modulator_0/nreset]
